...
class CharacterResponde {
  ...
  factory CharacterResponde.fromMap(Map<String, dynamic> data) {
    return CharacterResponde(
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [CharacterResponde].
  factory CharacterResponde.fromJson(String data) {
    return CharacterResponde.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [CharacterResponde] to a JSON string.
